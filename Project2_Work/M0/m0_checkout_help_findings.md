...
The [M0 baseline workflow](../../.github/workflows/m0-checkout-baseline.yml) now runs the selected checkout tests from `Project3`. The legacy [full-application workflow](../../.github/workflows/flutter-ci.yml) still points at `Project2` and targets `main`; that separate workflow needs review. M4 feature checks remain future work.

**Evaluation status (September 26, 2026):** The selected 50 baseline tests passed locally, and all three test groups passed in [baseline CI run 36263549665](https://github.com/closeabigaile/SEf26_project/actions/runs/36263549665). The Task 3 scoring script and synthetic fixtures produce the expected passing and failing calculations; the 13 scorer tests passed locally and [scoring CI run 36263549773](https://github.com/closeabigaile/SEf26_project/actions/runs/36263549773) succeeded. Both remote runs used commit `e628c4150b553d1b91f7500b1353912a28978500`. Participant testing was not conducted, user usefulness remains unverified, and M4 has not been implemented.
