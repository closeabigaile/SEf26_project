...
• Ranked by apparent end-user value; evidence is production code only (tests excluded).
   ...
   #                   1
   Actor goal          Look up product eligibility
  ...
  ─────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────
   #                   2
   Actor goal          Add product to basket
   Primary actor       WIC shopper
  ...
  ─────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────
   #                   3
   Actor goal          Review benefit balances
   Primary actor       WIC shopper
  ...
  ─────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────
   #                   4
   Actor goal          Review shopping basket
  ...
  ─────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────
   #                   5
   Actor goal          Adjust product quantity
   Primary actor       Shopper
  ...
  ─────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────
   #                   6
   Actor goal          Check category capacity
   Primary actor       WIC shopper
  ...
  ─────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────
   #                   7
   Actor goal          Add excess quantity as paid
   Primary actor       Shopper
  ...
  ─────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────
   #                   8
   Actor goal          Clear shopping basket
   Primary actor       Shopper
  ...
  ─────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────
   #                   10
   Actor goal          Add receipt products
   Primary actor       WIC shopper
  ...
  ─────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────
   #                   11
   Actor goal          Generate checkout QR code
   Primary actor       Shopper
  ...
  ─────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────
   #                   12
   Actor goal          Complete checkout transaction
   Primary actor       Shopper
  ...
  ─────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────
   #                   13
   Actor goal          Review product nutrition
  ...
  ─────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────
   #                   14
   Actor goal          Inspect basket-item nutrition
   Primary actor       Health-conscious shopper
  ...
  ─────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────
   #                   15
   Actor goal          Compare healthier alternatives
   Primary actor       Health-conscious shopper
  ...
  ─────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────
   #                   16
   Actor goal          Add healthier alternative
   Primary actor       Health-conscious shopper
  ...
  ─────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────
   #                   19
   Actor goal          Resume shopping state
   Primary actor       Returning shopper
  ...
  - “Food delivery application” is unsupported: the implemented route inventory contains authentication, scan, basket, balances, and receipt features—
    not restaurant ordering, delivery, drivers, or delivery status. (README.md:22, README.md:37; Project3/lib/app_router.dart:65)

  - “Track your orders in real-time” is unsupported: no order or tracking module/route exists. (README.md:76; Project3/lib/app_router.dart:65)
  - Receipt import “automatically check-out[s] each item” is unsupported: OCR finds APL products, then the shopper explicitly adds them to the basket;
    checkout is separate. (README.md:67; Project3/lib/screens/receipt_scanner_screen.dart:169)

  - “WIC eligibility verification” is overstated: lookup treats an existing APL document as a product result, without checking its eligible field in
    the lookup flow. (README.md:41; Project3/lib/services/apl_service.dart:31)

  Implemented user-visible behavior omitted from the README:

  - WIC category caps, contextual cap warnings, and PAID overflow for additional quantity. (Project3/lib/state/app_state.dart:122, Project3/lib/state/
    app_state.dart:451)

  - Per-category balance cards with usage progress and unlimited-category indicators. (Project3/lib/screens/balances_screen.dart:64)
  - Saved basket/balance restoration and automatic reset of usage/basket when a new month is detected. (Project3/lib/state/app_state.dart:227)
  - Manual UPC entry on wider layouts, alongside camera scanning. (Project3/lib/screens/scan_screen.dart:688)
  - Basket clearing, quantity removal, and explicit sign-out controls. (Project3/lib/screens/basket_screen.dart:207, Project3/lib/screens/
    balances_screen.dart:53)
